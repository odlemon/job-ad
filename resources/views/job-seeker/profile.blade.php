    ...
    <div class="flex-1 flex flex-col">
        ...
        <main class="flex-1 bg-gray-50 dark:bg-gray-900">
            <div class="max-w-7xl mx-auto px-6 py-8">
                ...
                <div class="rounded-2xl shadow-lg mb-8 overflow-hidden border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                    <div class="relative" style="min-height: 12rem;">
                        ...
                        <div class="h-20 w-full bg-white dark:bg-gray-800"></div>
                        ...
                        <div class="absolute flex items-end gap-5" style="left: 1.5rem; top: 7rem;">
                            <div class="relative flex-shrink-0" style="margin-top: -3rem;">
                                ...
                                <button type="button" onclick="document.getElementById('profile_photo_file').click()" id="profile-photo-upload-btn" class="absolute -bottom-0.5 -right-0.5 w-8 h-8 rounded-full bg-white dark:bg-gray-800 border-2 border-white shadow flex items-center justify-center hover:bg-gray-50 dark:hover:bg-gray-700 transition z-10">
                            ...
                            <h1 id="profile-header-name" class="font-sans text-2xl font-bold text-black dark:text-white pb-2">John Doe</h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-gray-100 dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <div class="flex items-center gap-2">
                                    <button type="button" id="personal-info-edit-btn" onclick="window.setPersonalInfoEditable(true)" class="px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition cursor-pointer">Edit</button>
                                    <button type="button" id="personal-info-cancel-btn" onclick="window.cancelPersonalInfoEdit()" class="hidden p-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-700 transition cursor-pointer" title="Cancel editing">
                            ...
                            <form id="personalInfoForm" class="space-y-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-3 shadow-sm dark:shadow-none">
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">First Name *</label>
                                        <input type="text" id="first_name" name="first_name" required disabled
                                            class="personal-info-input w-full border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-gray-900 dark:text-white bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 cursor-not-allowed">
                                    </div>
                                    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-3 shadow-sm dark:shadow-none">
                                    ...
                                    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-3 shadow-sm dark:shadow-none">
                                        ...
                                        <input type="email" id="email" name="email" readonly
                                            class="w-full border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 cursor-not-allowed">
                                    </div>
                                    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-3 shadow-sm dark:shadow-none">
                                    ...
                                    <div class="md:col-span-2 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-3 shadow-sm dark:shadow-none">
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Address</label>
                                        <input type="text" id="address" name="address" disabled
                                            class="personal-info-input w-full border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-gray-900 dark:text-white bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 cursor-not-allowed">
                                    </div>
                                    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-3 shadow-sm dark:shadow-none relative">
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Gender</label>
                                        <select id="gender" name="gender" disabled
                                            class="personal-info-input w-full border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 pr-9 bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 cursor-not-allowed appearance-none">
                                    ...
                                    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-3 shadow-sm dark:shadow-none relative">
                                        ...
                                        <input type="date" id="date_of_birth" name="date_of_birth" disabled
                                            class="personal-info-input w-full border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 pr-9 text-gray-900 dark:text-white bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 cursor-not-allowed">
                                        <p id="age-display" class="text-xs text-gray-500 dark:text-gray-400 mt-1"></p>
                                    </div>
                                    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-3 shadow-sm dark:shadow-none relative">
                                        ...
                                        <select id="employment_status" name="employment_status" disabled
                                            class="personal-info-input w-full border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 pr-9 bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 cursor-not-allowed appearance-none employment-status-select">
                                            <option value="">Select</option>
                                    ...
                                    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-3 shadow-sm dark:shadow-none relative">
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Driving License</label>
                                    ...
                                    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-3 shadow-sm dark:shadow-none relative">
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">License Issued Date</label>
                                        <input type="date" id="license_issued_date" name="license_issued_date" disabled
                                            class="personal-info-input w-full border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-gray-900 dark:text-white bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 cursor-not-allowed">
                                        <p id="license-issued-date-display" class="text-xs text-gray-500 dark:text-gray-400 mt-1"></p>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-none p-6">
                            ...
                            <div id="about-display" class="text-gray-700 dark:text-gray-300">
                            ...
                            <div id="about-edit" class="hidden">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1"><span id="bio-char-count">0</span>/5000 characters</p>
                                <div class="flex space-x-3 mt-4">
                                    ...
                                    <button onclick="cancelAbout()" class="border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 px-6 py-2 rounded-lg font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition">Cancel</button>
                                </div>
                            </div>
                        </div>

                        <!-- Job Preferences Section -->
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-none p-5 border border-gray-100 dark:border-gray-700">
                            <div class="flex items-center justify-between mb-3">
                                <div class="flex items-center gap-2">
                                    ...
                                    <h2 class="text-base font-semibold text-gray-900 dark:text-white">Job Preferences</h2>
                                </div>
                            ...
                            <div id="job-preferences-display" class="flex flex-wrap gap-2">
                                <span class="px-4 py-1.5 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-md text-sm">No preferences set</span>
                            </div>
                            <div id="job-preferences-edit" class="hidden mt-4">
                                ...
                                <div class="flex space-x-3 mt-4">
                                    ...
                                    <button onclick="cancelJobPreferences()" class="border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 px-6 py-2 rounded-lg font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition">Cancel</button>
                                </div>
                            </div>
                        </div>

                        <!-- Salary Range Section -->
                        <div class="bg-white dark:bg-gray-800 rounded-md shadow-sm dark:shadow-none p-5 border border-gray-100 dark:border-gray-700 mt-4">
                            <div class="flex items-center justify-between mb-3">
                                <div class="flex items-center gap-2">
                                    <span class="text-emerald-600 text-lg font-semibold leading-none">$</span>
                                    <div>
                                        <h2 class="text-base font-semibold text-gray-900 dark:text-white">Salary Range</h2>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">Expected salary range to show employers</p>
                                    </div>
                                </div>
                            ...
                            <div class="space-y-3">
                                <div class="relative">
                                    <input type="range" id="salary_min_range" min="0" max="100000" step="1000"
                                        class="w-full h-1 rounded-full appearance-none bg-gray-200 dark:bg-gray-700 outline-none cursor-default salary-range-input" disabled>
                                ...
                                <div id="salary-range-actions" class="hidden flex items-center gap-2 pt-2">
                                    <button type="button" onclick="window.cancelSalaryRange()" class="px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition">Cancel</button>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-md shadow-sm dark:shadow-none p-5 border border-gray-100 dark:border-gray-700 mt-4">
                            <div class="flex items-center space-x-2 mb-4">
                                ...
                                <h2 class="text-base font-semibold text-gray-900 dark:text-white">Job Discovery</h2>
                            </div>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-3">Select job categories you're interested in (max 6)</p>
                            <select id="category-select" class="w-full border border-gray-300 dark:border-gray-600 rounded-md px-4 py-2 mb-3 bg-white dark:bg-gray-800 text-gray-900 dark:text-white cursor-pointer">
                                <option value="">Select a category...</option>
                            </select>
                            <div id="category-preferences-display" class="flex flex-wrap gap-2 mb-2">
                                <span class="px-4 py-2 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-md text-sm">No categories selected</span>
                            </div>
                            <p class="text-xs text-gray-500 dark:text-gray-400" id="category-count">0 of 6 categories selected</p>
                        </div>

                        <!-- Work Experience Section (design: blue briefcase, timeline dots+line, white cards, Current pill, X) -->
                        <div class="bg-white dark:bg-gray-800 rounded-md shadow-sm dark:shadow-none p-6 border border-gray-100 dark:border-gray-700">
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex items-center gap-2">
                                    <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                                    </svg>
                                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Work Experience</h2>
                                </div>
                            ...
                            <div id="experiences-list" class="relative">
                                <div id="experiences-skeleton" class="space-y-4">
                                    <div class="flex gap-4 animate-pulse">
                                        <div class="w-4 flex justify-center flex-shrink-0"><div class="w-2.5 h-2.5 rounded-full bg-gray-300 dark:bg-gray-600"></div></div>
                                        <div class="flex-1 rounded-md border border-gray-200 dark:border-gray-700 p-4 space-y-2">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-md shadow-sm dark:shadow-none p-6 border border-gray-100 dark:border-gray-700 mt-6">
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex items-center gap-2">
                                    ...
                                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Education</h2>
                                </div>
                            ...
                            <div id="educations-list" class="space-y-4">
                                <div id="educations-skeleton" class="space-y-4">
                                    <div class="rounded-md border border-gray-200 dark:border-gray-700 p-4 animate-pulse space-y-2">
                                        <div class="h-4 bg-gray-200 dark:bg-gray-700 rounded w-3/4"></div>
                                        <div class="h-3 bg-gray-200 dark:bg-gray-700 rounded w-1/2"></div>
                                        <div class="h-3 bg-gray-200 dark:bg-gray-700 rounded w-1/3"></div>
                                    </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-none p-6">
                            ...
                            <div id="skills-list" class="flex flex-wrap gap-2">
                                <div id="skills-skeleton" class="flex flex-wrap gap-2 animate-pulse">
                                    <div class="h-8 bg-gray-200 dark:bg-gray-700 rounded-full w-24"></div>
                                    <div class="h-8 bg-gray-200 dark:bg-gray-700 rounded-full w-28"></div>
                                    <div class="h-8 bg-gray-200 dark:bg-gray-700 rounded-full w-20"></div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-none p-6">
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex items-center gap-2">
                                    ...
                                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Languages</h2>
                                </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-none p-6">
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Hobbies & Interests</h2>
                                </div>
                            ...
                            <div id="hobbies-display" class="flex flex-wrap gap-2">
                                <span class="px-4 py-2 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-md text-sm">No hobbies added</span>
                            </div>
                            <div id="hobbies-edit" class="hidden mt-4">
                                ...
                                <div class="flex space-x-3 mt-4">
                                    ...
                                    <button onclick="cancelHobbies()" class="border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 px-6 py-2 rounded-lg font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition">Cancel</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-none p-6">
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex items-center gap-2">
                                    ...
                                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">References</h2>
                                </div>
                    ...
                    <div class="space-y-6">
                        <!-- Profile Strength -->
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-none p-6">
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4">Profile Strength</h3>
                            <div class="flex items-center justify-center mb-4">
                                <div class="relative w-32 h-32">
                                    ...
                                    <div class="absolute inset-0 flex flex-col items-center justify-center">
                                        <span id="profile-strength-percent" class="text-3xl font-bold text-gray-900 dark:text-white">0%</span>
                        ...
                        <!-- Documents -->
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-none p-6">
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4">Documents</h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Upload resumes, certificates, or other documents. Give each one a name. Mark one as your primary resume for job applications.</p>
                            <div id="documents-list" class="space-y-3 mb-4">
                                <!-- Document items rendered by JS -->
                            </div>
                            <div id="documents-empty" class="text-sm text-gray-500 dark:text-gray-400 py-4 text-center border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-lg mb-4 hidden">No documents yet. Add one below.</div>
                            <!-- Add document form -->
                            <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 bg-gray-50/50">
                                <p class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Add a document</p>
                                <div class="flex flex-wrap gap-3 items-end">
                                    <div class="min-w-[180px] flex-1">
                                        <label for="document-name" class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Document name</label>
                                        <input type="text" id="document-name" placeholder="e.g. Resume, Cover Letter, Certificate" maxlength="255" class="w-full rounded-lg border border-gray-300 dark:border-gray-600 px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <input type="file" id="document-file" accept=".pdf,.doc,.docx" class="sr-only" aria-hidden="true">
                                        <label for="document-file" id="document-file-trigger" class="rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer inline-flex items-center gap-2">
                                            <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M7 10l5 5m0 0l5-5m-5 5V4"></path></svg>
                                            Choose file
                                        </label>
                                        <span id="document-file-name" class="text-sm text-gray-500 dark:text-gray-400 truncate max-w-[120px]"></span>
                                    </div>
                                    <label class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 cursor-pointer">
                                        <input type="checkbox" id="document-is-primary" class="rounded border-gray-300 dark:border-gray-600 text-blue-600 focus:ring-blue-500">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-none p-6 border border-gray-100 dark:border-gray-700">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Social Links</h3>
                                <button type="button" id="social-links-edit-btn" onclick="window.setSocialLinksEditable(true)" class="p-1.5 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-700 transition cursor-pointer" title="Edit social links">
                            ...
                            <div id="social-links-display" class="space-y-4">
                                <div id="social-link-facebook-row" class="flex items-center gap-3 hidden">
                                    ...
                                    <a id="social-link-facebook" href="#" target="_blank" rel="noopener" class="text-gray-700 dark:text-gray-300 text-base truncate hover:underline"></a>
                                </div>
                                <div id="social-link-instagram-row" class="flex items-center gap-3 hidden">
                                    ...
                                    <a id="social-link-instagram" href="#" target="_blank" rel="noopener" class="text-gray-700 dark:text-gray-300 text-base truncate hover:underline"></a>
                                </div>
                                <div id="social-link-linkedin-row" class="flex items-center gap-3 hidden">
                                    ...
                                    <a id="social-link-linkedin" href="#" target="_blank" rel="noopener" class="text-gray-700 dark:text-gray-300 text-base truncate hover:underline"></a>
                                </div>
                                <div id="social-link-website-row" class="flex items-center gap-3 hidden">
                                    ...
                                    <a id="social-link-website" href="#" target="_blank" rel="noopener" class="text-gray-700 dark:text-gray-300 text-base truncate hover:underline"></a>
                                </div>
                                <p id="social-links-empty" class="text-sm text-gray-500 dark:text-gray-400">No social links added yet.</p>
                            </div>
                            <!-- Edit mode: inputs -->
                            <div id="social-links-edit" class="hidden space-y-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <input type="url" id="facebook_url" placeholder="facebook.com/username" class="social-links-input flex-1 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                </div>
                                <div class="flex items-center gap-3">
                                    ...
                                    <input type="url" id="instagram_url" placeholder="instagram.com/username" class="social-links-input flex-1 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                </div>
                                <div class="flex items-center gap-3">
                                    ...
                                    <input type="url" id="linkedin_url" placeholder="linkedin.com/in/username" class="social-links-input flex-1 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                </div>
                                <div class="flex items-center gap-3">
                                    ...
                                    <input type="url" id="website_url" placeholder="yourwebsite.com" class="social-links-input flex-1 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                </div>
                                <div class="flex items-center gap-2 pt-1">
                                    <button type="button" onclick="window.cancelSocialLinksEdit()" class="px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition cursor-pointer">Cancel</button>
                        ...
                        <!-- Visibility -->
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-none p-6">
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4">Visibility</h3>
                            <div class="space-y-3">
                                <label class="flex items-center">
                                    <input type="checkbox" id="public_profile" name="public_profile" class="w-4 h-4 text-blue-600 border-gray-300 dark:border-gray-600 rounded focus:ring-blue-500">
                                    <span class="ml-3 text-sm text-gray-700 dark:text-gray-300">Public Profile</span>
                                </label>
                                <label class="flex items-center">
                                    <input type="checkbox" id="open_to_opportunities" name="open_to_opportunities" class="w-4 h-4 text-blue-600 border-gray-300 dark:border-gray-600 rounded focus:ring-blue-500">
                                    <span class="ml-3 text-sm text-gray-700 dark:text-gray-300">Open to Opportunities</span>
                                </label>

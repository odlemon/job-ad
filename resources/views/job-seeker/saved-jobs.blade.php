...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div id="saved-jobs-container" class="space-y-4">
        <div class="text-center py-12">
            ...
            <p class="text-gray-500">Loading saved jobs...</p>
        </div>
    </div>
</div>
        ...
        try {
            ...
            if (data.data && data.data.length > 0) {
                container.innerHTML = data.data.map((saved, index) => {
                        const job = saved.job;
                        return `
                            <div class="bg-white rounded-lg shadow-sm hover:shadow-md transition-smooth p-6 border border-gray-100 fade-in" style="animation-delay: ${index * 0.05}s">
                                <div class="flex items-start justify-between">
                                    ...
                                    <div class="ml-4 flex flex-col space-y-2">
                                        ...
                                        <button onclick="unsaveJob(${job.id})" class="border border-gray-300 text-gray-700 px-6 py-2 rounded-lg font-semibold hover:bg-gray-50 transition whitespace-nowrap">
                                            Remove
                                        </button>
                                    </div>
                                </div>
                    ...
                    container.innerHTML = '<div class="text-center py-12 text-gray-500"><p class="text-lg mb-2">No saved jobs yet</p><p class="text-sm"><a href="/jobs" wire:navigate class="text-blue-600 hover:underline">Browse jobs</a> to save them!</p></div>';
                }
            } catch (error) {

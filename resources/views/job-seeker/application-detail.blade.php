    ...
    <div class="flex-1 flex flex-col">
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                <div class="flex items-start justify-between mb-4">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-lg text-gray-600 mb-2">{{ $company->name ?? 'Unknown Company' }}</p>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-gray-200">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-900">{{ $application->reviewed_at->format('M d, Y') }}</p>
                    </div>
                    @endif
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-900 whitespace-pre-wrap">{{ $job->description }}</p>
                    </div>
                    @endif
                    @if($job->location)
                    <div>
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-900">{{ ucfirst(str_replace('_', ' ', $job->employment_type)) }}</p>
                    </div>
                    @endif
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                ...
                <p class="text-sm text-gray-900 whitespace-pre-wrap">{{ $application->notes }}</p>
            </div>
            @endif
...
<div id="noteModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            <h3 class="text-lg font-medium text-gray-900 mb-4">{{ $application->notes ? 'Edit Note' : 'Add Note' }}</h3>
            <textarea id="noteText" rows="6" class="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Add a note about this application...">{{ $application->notes }}</textarea>

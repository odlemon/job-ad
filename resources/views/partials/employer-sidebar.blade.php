...
<aside class="w-64 bg-white h-screen fixed left-0 top-0 border-r border-gray-200 flex flex-col overflow-y-auto z-30">
    ...
    <nav class="flex-1 px-4 py-4 space-y-1">
        ...
        <!-- Company Profile -->
        <a href="{{ route('employer.company-profile') }}" wire:navigate class="flex items-center space-x-3 px-4 py-3 rounded-lg transition {{ $isCompanyProfile ? 'bg-gradient-to-r from-blue-500 to-cyan-400 text-white shadow-md' : 'text-gray-700 hover:bg-gray-50' }}">

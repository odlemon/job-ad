...
<div class="min-h-screen bg-white dark:bg-gray-800">
    ...
    <div class="flex">
        ...
        <main class="flex-1 p-6 ml-64 w-0 min-w-0">
            <div class="w-full">
                <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm dark:shadow-none overflow-hidden rounded-lg">
                    <div class="flex items-start justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Create and manage your tenders.</p>
                        </div>
                        ...
                        <table class="min-w-full">
                            <thead>
                                <tr class="border-b border-gray-200 dark:border-gray-700 bg-gray-50/50">
                                    <th class="px-6 py-3.5 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Title</th>
                                    ...
                                    <th class="px-6 py-3.5 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Location</th>
                                    <th class="px-6 py-3.5 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Submission deadline</th>
                            ...
                            <tbody id="tenders-tbody">
                                @forelse($tenders as $t)
                                    <tr class="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50/50 transition" data-tender-id="{{ $t->id }}">
                                        <td class="px-6 py-4">
                                            <span class="text-sm font-semibold text-gray-900 dark:text-white">{{ $t->title }}</span>
                                            @if($t->entity_name)
                                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{{ $t->entity_name }}</p>
                                            @endif
                                        </td>
                                        <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">{{ $t->reference_number ?? '—' }}</td>
                                        <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">{{ $t->tender_type ?? '—' }}</td>
                                        <td class="px-6 py-4">
                                            @php
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">{{ $t->location ?? '—' }}</td>
                                        <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">{{ $t->submission_deadline ? $t->submission_deadline->format('M d, Y') : '—' }}</td>
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <button type="button" class="btn-tender-edit p-1.5 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded" title="Edit" data-tender-id="{{ $t->id }}">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                                </button>
                                                <button type="button" class="btn-tender-delete p-1.5 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded" title="Delete" data-tender-id="{{ $t->id }}">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-700 flex-shrink-0" style="background:linear-gradient(180deg,#f0f4ff 0%,#fff 100%);">
            <div class="flex items-center justify-between">
                <div>
                    <h3 id="ctm-title" class="text-xl font-bold text-gray-900 dark:text-white">Create Tender</h3>
                    <p id="ctm-step-label" class="text-sm text-blue-600 mt-0.5">Step 1 of 4</p>
                </div>
                <button type="button" id="ctm-close" class="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition">
        ...
        <div class="flex-1 overflow-y-auto p-6 bg-white dark:bg-gray-800">
            <form id="create-tender-form">
                ...
                <div class="flex items-center justify-center gap-2 mb-8">
                    ...
                    <div id="ctm-ind-2" class="w-9 h-9 rounded-full bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 text-gray-400 flex items-center justify-center text-sm font-bold">2</div>
                    <div class="w-8 h-0.5 bg-gray-300 dark:bg-gray-600"></div>
                    <div id="ctm-ind-3" class="w-9 h-9 rounded-full bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 text-gray-400 flex items-center justify-center text-sm font-bold">3</div>
                    <div class="w-8 h-0.5 bg-gray-300 dark:bg-gray-600"></div>
                    <div id="ctm-ind-4" class="w-9 h-9 rounded-full bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 text-gray-400 flex items-center justify-center text-sm font-bold">4</div>
                    <div class="w-8 h-0.5 bg-gray-300 dark:bg-gray-600"></div>
                    <div id="ctm-ind-5" class="w-9 h-9 rounded-full bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 text-gray-400 flex items-center justify-center text-sm font-bold">5</div>
                </div>

                <!-- Step 1: Basic info -->
                <div id="ctm-step-1">
                    <h4 class="text-lg font-bold text-gray-900 dark:text-white mb-4">Basic Information</h4>
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Title *</label>
                            <input type="text" name="title" id="tender_title" required class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Tender title">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="reference_number" id="tender_reference_number" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500" placeholder="e.g. REF-2024-001">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tender type</label>
                                <select name="tender_type" id="tender_tender_type" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <select name="category_id" id="tender_category_id" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="tender_description" rows="4" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500" placeholder="Full description"></textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Summary</label>
                            <textarea name="summary" id="tender_summary" rows="2" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500" placeholder="Brief summary"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div id="ctm-step-2" class="hidden">
                    <h4 class="text-lg font-bold text-gray-900 dark:text-white mb-4">Entity & Location</h4>
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Entity / Organisation name</label>
                            <input type="text" name="entity_name" id="tender_entity_name" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500" placeholder="Company or organisation name">
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Sector</label>
                                <input type="text" name="sector" id="tender_sector" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500" placeholder="e.g. Construction, IT">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Procuring entity</label>
                                <input type="text" name="procuring_entity" id="tender_procuring_entity" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500" placeholder="Procuring entity">
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Country / Region</label>
                                <input type="text" name="country_region" id="tender_country_region" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500" placeholder="e.g. Seychelles">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Location</label>
                                <input type="text" name="location" id="tender_location" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500" placeholder="Specific location">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="ctm-step-3" class="hidden">
                    <h4 class="text-lg font-bold text-gray-900 dark:text-white mb-4">Scope & Requirements</h4>
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Scope of work</label>
                            <textarea name="scope_of_work" id="tender_scope_of_work" rows="4" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500" placeholder="Describe the scope of work"></textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Requirements (one per line)</label>
                            <textarea name="requirements_text" id="tender_requirements_text" rows="4" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500" placeholder="Each requirement on a new line"></textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Eligibility criteria (one per line)</label>
                            <textarea name="eligibility_text" id="tender_eligibility_text" rows="3" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500" placeholder="Each criterion on a new line"></textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Required documents (one per line)</label>
                            <textarea name="required_docs_text" id="tender_required_docs_text" rows="3" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500" placeholder="e.g. Company registration, Tax certificate"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div id="ctm-step-4" class="hidden">
                    <h4 class="text-lg font-bold text-gray-900 dark:text-white mb-4">Dates & Budget</h4>
                    <div class="space-y-4">
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Start date</label>
                                <input type="date" name="start_date" id="tender_start_date" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">End date</label>
                                <input type="date" name="end_date" id="tender_end_date" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Published date</label>
                                <input type="date" name="published_date" id="tender_published_date" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Clarification deadline</label>
                                <input type="date" name="clarification_deadline" id="tender_clarification_deadline" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Submission deadline *</label>
                                <input type="date" name="submission_deadline" id="tender_submission_deadline" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500">
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Amount (fixed)</label>
                                <input type="number" step="0.01" min="0" name="amount" id="tender_amount" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500" placeholder="0.00">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Currency</label>
                                <select name="currency" id="tender_currency" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" step="0.01" min="0" name="budget_min" id="tender_budget_min" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500" placeholder="0.00">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Budget max</label>
                                <input type="number" step="0.01" min="0" name="budget_max" id="tender_budget_max" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500" placeholder="0.00">
                            </div>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Submission method</label>
                            <input type="text" name="submission_method" id="tender_submission_method" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500" placeholder="e.g. Online portal, Email">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Status after create</label>
                            <select name="status" id="tender_status" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500">
                ...
                <div id="ctm-step-5" class="hidden">
                    <h4 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Documents</h4>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Upload documents that will be available for download on the tender page. Optionally set a display name before choosing the file.</p>
                    ...
                    <div class="flex items-center gap-3 flex-wrap">
                        ...
                        <input type="text" id="tender-doc-name" class="flex-1 min-w-[180px] border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Document name (optional)">
                        <button type="button" id="tender-doc-add-btn" class="inline-flex items-center gap-2 px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-700">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg>
                            Choose file &amp; upload
                        </button>
                    </div>
        ...
        <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex justify-between flex-shrink-0 bg-gray-50 dark:bg-gray-900">
            <button type="button" id="ctm-prev" class="px-5 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 font-medium text-sm hover:bg-gray-100 dark:hover:bg-gray-700 hidden">Previous</button>
...
<div id="view-tender-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4" style="background:rgba(0,0,0,0.4);backdrop-filter:blur(2px);">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between flex-shrink-0">
            <h3 class="text-lg font-bold text-gray-900 dark:text-white">Tender Details</h3>
            <button type="button" id="view-tender-close" class="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
            </button>
        </div>
        <div id="view-tender-body" class="flex-1 overflow-y-auto p-6 text-sm text-gray-700 dark:text-gray-300 space-y-4"></div>
        <div id="view-tender-footer" class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-2 flex-shrink-0 bg-gray-50 dark:bg-gray-900">
            ...
            <button type="button" id="view-tender-close-btn" class="px-5 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 font-medium text-sm hover:bg-gray-100 dark:hover:bg-gray-700">Close</button>
        </div>
    </div>
</div>
...
(function() {
    ...
    function setSidebarHiddenForTender(hidden) {
        var sidebar = document.getElementById('employer-sidebar');
        ...
        if (main) {
            if (hidden) main.classList.remove('ml-64');
            else main.classList.add('ml-64');
        }
    }
    ...
    function openTenderModal() {
        ...
        setSidebarHiddenForTender(true);
    }

    function closeTenderModal() {
        modal.classList.add('hidden');
        modal.classList.remove('flex');
        setSidebarHiddenForTender(false);
    }
    ...
    function renderTenderActionsCell(tenderId) {
        return '<div class="flex items-center gap-2">' +
            ...
            '<button type="button" class="btn-tender-edit p-1.5 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded" title="Edit" data-tender-id="' + tenderId + '"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg></button>' +
            '<button type="button" class="btn-tender-delete p-1.5 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded" title="Delete" data-tender-id="' + tenderId + '"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg></button>' +
            '</div>';
    }
    ...
    function renderTenderDocsList() {
        ...
        list.innerHTML = tenderDocsArray.map(function(doc, idx) {
            ...
            return '<div class="flex items-center gap-3 p-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900" data-doc-idx="' + idx + '">' +
                '<div class="flex-1 min-w-0">' +
                '<p class="text-sm font-medium text-gray-900 dark:text-white truncate">' + name + '</p>' +
                (meta.length ? '<p class="text-xs text-gray-500 dark:text-gray-400">' + meta.join(' \u2022 ') + '</p>' : '') +
                '</div>' +
                '<button type="button" class="tender-doc-remove p-2 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition" data-doc-idx="' + idx + '" title="Remove">' +
    ...
    function updateTenderRowInTable(tenderId, t) {
        ...
        var entityCell = t.entity_name ? '<p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">' + (t.entity_name || '') + '</p>' : '';
        row.children[0].innerHTML = '<span class="text-sm font-semibold text-gray-900 dark:text-white">' + (t.title || '') + '</span>' + entityCell;
    ...
    document.getElementById('tenders-tbody').addEventListener('click', async function(e) {
        ...
        if (deleteBtn) {
            ...
            var confirmed = await window.showConfirmDialog(
                ...
                .then(function(result) {
                    if (result.data.success && row) {
                        ...
                        if (tbody.children.length === 0) {
                            tbody.innerHTML = '<tr><td colspan="7" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400"><p class="text-sm">No tenders yet.</p><p class="text-xs mt-1">Click "Create Tender" to add one.</p></td></tr>';
                        }
    ...
    document.getElementById('tender-doc-file').addEventListener('change', function(e) {
        ...
        row.className = 'flex items-center gap-3 p-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900';
        row.innerHTML = '<div class="flex-1 min-w-0"><p class="text-sm font-medium text-gray-900 dark:text-white">' + name.replace(/</g, '&lt;').replace(/>/g, '&gt;') + '</p><p class="text-xs text-blue-600 flex items-center gap-1"><span class="spinner-sm inline-block w-3 h-3"></span> Uploading...</p></div>';
        ...
        .then(function(result) {
            if (result.ok && result.data.tender) {
                ...
                if (isEdit) {
                    ...
                    var newRow = '<tr class="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50/50 transition" data-tender-id="' + t.id + '">' +
                        '<td class="px-6 py-4"><span class="text-sm font-semibold text-gray-900 dark:text-white">' + (t.title || '') + '</span>' + entityCell + '</td>' +
                        '<td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">' + (t.reference_number || '—') + '</td>' +
                        '<td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">' + (t.tender_type || '—') + '</td>' +
                        '<td class="px-6 py-4"><span class="px-2.5 py-1 text-xs font-medium rounded ' + statusClass + '">' + statusLabel + '</span></td>' +
                        '<td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">' + (t.location || '—') + '</td>' +
                        '<td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">' + (t.submission_deadline || '—') + '</td>' +

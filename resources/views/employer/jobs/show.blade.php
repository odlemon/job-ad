            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-none border border-gray-200 dark:border-gray-700 p-6 mb-6">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        <div>
                            ...
                            <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $job->location ?? 'Not specified' }}</p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500 dark:text-gray-400 mb-1">Employment Type</p>
                            <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $job->employment_type ? ucfirst(str_replace('_', ' ', $job->employment_type)) : 'Not specified' }}</p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500 dark:text-gray-400 mb-1">Experience Level</p>
                            <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $job->experience_level ? ucfirst($job->experience_level) : 'Not specified' }}</p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500 dark:text-gray-400 mb-1">Remote Work</p>
                            <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $job->is_remote ? 'Yes' : 'No' }}</p>
                        </div>
                        ...
                        <div>
                            <p class="text-sm text-gray-500 dark:text-gray-400 mb-1">Application Deadline</p>
                            <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $job->application_deadline->format('M d, Y') }}</p>
                        </div>
                        @endif
                    </div>
                ...
                <div class="grid grid-cols-3 gap-4 mb-6">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-none border border-gray-200 dark:border-gray-700 p-6">
                        <div class="text-3xl font-bold text-gray-900 dark:text-white mb-1">{{ $job->views_count ?? 0 }}</div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-none border border-gray-200 dark:border-gray-700 p-6">
                        ...
                        <div class="text-sm text-gray-500 dark:text-gray-400">{{ $job->created_at->format('M d, Y') }}</div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-none border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <div class="flex items-center space-x-3">
                        <a href="{{ route('employer.jobs.edit', $job->id) }}" wire:navigate class="px-4 py-2 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 transition font-medium">
                            Edit Job
                        </a>

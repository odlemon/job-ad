                ...
                <div class="relative" id="user-menu-container">
                    <button type="button" id="user-menu-button" class="flex items-center focus:outline-none">
                        <div class="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center cursor-pointer">
                            <span id="user-initials" class="text-white text-sm font-semibold"><?php echo e($userInitials); ?></span>
                        </div>
                    </button>
...
<?php /**PATH C:\Users\lysp\Downloads\Job Ad\resources\views/partials/job-seeker-navbar.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <title><?php echo e($title ?? 'JobHub - Find Your Next Career Opportunity'); ?></title>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    ...
                    <div class="hidden md:flex items-center space-x-6">
                        <a href="<?php echo e(route('jobs.index')); ?>" wire:navigate class="text-gray-700 hover:text-blue-600 transition">Search Jobs</a>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->check()): ?>
                            <a href="<?php echo e(route('dashboard')); ?>" wire:navigate class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">
                                Dashboard
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" wire:navigate class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">
                                Login/Signup
                            </a>
    ...
    <footer class="bg-gray-900 text-white mt-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-400">
                        <li><a href="<?php echo e(route('jobs.index')); ?>" wire:navigate class="hover:text-white transition">Browse Jobs</a></li>
                        <li><a href="<?php echo e(route('register')); ?>" wire:navigate class="hover:text-white transition">Create Profile</a></li>
            ...
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
                <p>&copy; <?php echo e(date('Y')); ?> JobHub. All rights reserved.</p>
            </div>
        </div>
    </footer>
</body>
</html>
<?php /**PATH C:\Users\lysp\Downloads\Job Ad\resources\views/layouts/app.blade.php ENDPATH**/ ?>
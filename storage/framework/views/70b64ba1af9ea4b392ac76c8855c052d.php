        ...
        <main class="flex-1 p-8 ml-64">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
                    <form method="GET" action="<?php echo e(route('employer.jobs.index')); ?>" class="flex items-center space-x-3">
                        <!-- Search Input -->
                        ...
                        <div class="relative">
                            ...
                            >
                                ...
                                <option value="paused" <?php echo e($currentStatus === 'paused' ? 'selected' : ''); ?>>Paused</option>
                                <option value="draft" <?php echo e($currentStatus === 'draft' ? 'selected' : ''); ?>>Draft</option>
                                <option value="closed" <?php echo e($currentStatus === 'closed' ? 'selected' : ''); ?>>Closed</option>
                            </select>
                        ...
                        <table class="min-w-full">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <tr class="border-b border-gray-100 hover:bg-gray-50/50 transition group" data-job-id="<?php echo e($job->id); ?>" style="border-left: 3px solid #f59e0b;">
                                        <!-- JOB TITLE -->
                                        <td class="px-6 py-4">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    <div class="flex items-center space-x-2">
                                                        <span class="text-sm font-semibold text-gray-900"><?php echo e($job->title); ?></span>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->status === 'published' && $job->created_at->diffInDays(now()) < 7): ?>
                                        ...
                                        <td class="px-6 py-4">
                                            <span class="text-sm text-gray-600">
                                                <?php echo e(ucfirst(str_replace('_', '-', $job->employment_type ?? 'Full-time'))); ?>
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            ?>
                                            <span class="inline-flex items-center px-2.5 py-1 text-xs font-medium rounded-md <?php echo e($statusInfo['class']); ?>">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center text-sm text-gray-600">
                                                ...
                                                <span class="font-medium"><?php echo e($job->applications_count ?? $job->applications()->count()); ?></span>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center text-sm text-gray-600">
                                                ...
                                                <span class="font-medium"><?php echo e(number_format($job->views_count ?? 0)); ?></span>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4" style="position: relative; overflow: visible;">
                                            <div class="flex items-center space-x-1">
                                                <!-- Edit -->
                                                <button onclick="openEditJobModal(<?php echo e($job->id); ?>)" class="p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition" title="Edit">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->status === 'published'): ?>
                                                    <button onclick="toggleJobStatus(<?php echo e($job->id); ?>)" class="p-2 text-gray-400 hover:text-amber-600 hover:bg-amber-50 rounded-lg transition" title="Pause">
                                                        <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 9v6m4-6v6m7-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                                        </svg>
                                                    </button>
                                                <?php else: ?>
                                                    <button onclick="toggleJobStatus(<?php echo e($job->id); ?>)" class="p-2 text-gray-400 hover:text-green-600 hover:bg-green-50 rounded-lg transition" title="Activate">
                                                        <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <!-- Analytics/Chart -->
                                                <button onclick="openShowJobModal(<?php echo e($job->id); ?>)" class="p-2 text-gray-400 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition" title="Analytics">
                                                    <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <div class="relative inline-block" style="z-index: 9999;">
                                                    <button onclick="toggleMoreMenu(<?php echo e($job->id); ?>)" class="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition" title="More options">
                                                    ...
                                                    <div id="more-menu-<?php echo e($job->id); ?>" class="hidden absolute right-0 top-full mt-1 w-48 bg-white rounded-lg shadow-2xl border border-gray-200 overflow-hidden" style="z-index: 99999; min-width: 12rem; position: absolute;">
                                                        <button onclick="openShowJobModal(<?php echo e($job->id); ?>)" class="w-full text-left block px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition whitespace-nowrap">View Details</button>
                                                        <button onclick="deleteJob(<?php echo e($job->id); ?>)" class="w-full text-left block px-4 py-2.5 text-sm text-red-600 hover:bg-red-50 transition whitespace-nowrap">Delete</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (form) {
        form.addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch('<?php echo e(route("employer.jobs.store")); ?>', {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
...
<?php echo $__env->make('layouts.employer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lysp\Downloads\Job Ad\resources\views/employer/jobs/index.blade.php ENDPATH**/ ?>
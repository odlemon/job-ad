        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center space-x-4 ml-6">
                ...
                <div class="flex items-center space-x-1.5 bg-orange-500 px-3 py-1.5 rounded-md">
                    <span id="coin-balance" class="font-semibold text-white text-sm"><?php echo e(number_format($employer->coin_balance ?? 0)); ?></span>
                ...
                <div class="relative" id="notification-container">
                    <button id="notification-button" type="button" class="p-2 text-gray-600 hover:text-gray-900 transition relative" onclick="event.stopPropagation();">
                        ...
                        <span id="notification-badge" class="absolute top-0 right-0 w-2 h-2 bg-red-500 rounded-full"></span>
                    </button>
                ...
                <div class="relative" id="user-menu-container">
                    <button id="user-menu-button" class="flex items-center space-x-3 hover:opacity-80 transition cursor-pointer">
                        <div class="text-right">
                            <div id="company-name" class="font-semibold text-gray-900"><?php echo e($companyName); ?></div>
                            <div class="text-sm text-gray-500">Admin</div>
                        </div>
                        <div class="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center">
                            <span id="company-initials" class="text-white font-semibold"><?php echo e($companyInitials); ?></span>
                        </div>
                    </button>
                    ...
                    <div id="user-menu-dropdown" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
                        <a href="<?php echo e(route('employer.dashboard')); ?>" wire:navigate class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Dashboard</a>
                        <a href="<?php echo e(route('employer.company-profile')); ?>" wire:navigate class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Company Profile</a>
...
<?php /**PATH C:\Users\lysp\Downloads\Job Ad\resources\views/partials/employer-navbar.blade.php ENDPATH**/ ?>
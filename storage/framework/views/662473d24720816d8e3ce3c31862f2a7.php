        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 space-y-8">
            ...
            <div class="text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="<?php echo e(route('register')); ?>" wire:navigate class="font-semibold text-blue-600 hover:text-blue-500 transition">
                        Create one now
                    </a>
                </p>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lysp\Downloads\Job Ad\resources\views/auth/login.blade.php ENDPATH**/ ?>
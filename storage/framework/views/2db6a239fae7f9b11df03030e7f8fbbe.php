    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-8">
                ...
                <a href="<?php echo e(route('jobs.index')); ?>" wire:navigate class="text-pink-600 hover:text-pink-700 font-semibold text-sm">View all</a>
            </div>
            ...
            <div class="bg-white rounded-2xl overflow-hidden shadow-xl">
                <div class="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div class="hidden lg:block">
                        <img src="<?php echo e(asset('images/app-promo-banner.png')); ?>" alt="Job searching made easier on the move" class="w-full h-full object-cover">
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lysp\Downloads\Job Ad\resources\views/landing/index.blade.php ENDPATH**/ ?>